...
import com.zxs.people.mapper.FeedbackMapper;
import com.zxs.people.service.FeedbackService;
...
public class FeedbackServiceImpl extends ServiceImpl<FeedbackMapper, Feedback> implements FeedbackService {
    ...
    public PageResult<Feedback> feedbackPage(FeedbackQueryVo feedbackQueryVo) {
        ...
        return new PageResult<>(
                pageNew.getRecords(),                     // List<Feedback>
                pageNew.getTotal(),                       // Long
                (int) pageNew.getPages(),                 // int -> 自动装箱为 Integer
                (int) feedbackQueryVo.getPageNum(),       // long -> int -> Integer
                (int) feedbackQueryVo.getPageSize()       // long -> int -> Integer
        );
    }
