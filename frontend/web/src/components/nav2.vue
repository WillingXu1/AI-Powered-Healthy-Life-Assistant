<template>
  <div class="main-nav" ref="navBarRef">
    <!-- 修改后的Logo区域 -->
    <div class="logo-box">
      <img src="@/assets/images/pig/logo.jpg" alt="Smart Health" class="logo-image">
    ...
    <div v-if="userStore.isLoggedIn" class="user-section">
      <el-dropdown trigger="click" @command="handleCommand">
        <span class="el-dropdown-link">
          <span class="user-name">欢迎您：{{ userStore.userInfo.userName || userStore.userInfo.userAccount }}</span>
          <img
...
const navItems = ['首页', '新闻资讯', '疾病百科', '药品信息', '智能医生', '健康文章', '搜索']
