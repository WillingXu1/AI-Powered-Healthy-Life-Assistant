    ...
    <div v-else class="content">
      ...
      <el-card class="record-header">
        ...
        <div class="header-left">
          ...
          <img class="icon" :src="getStableImage(illnessData.kind_id)" alt="疾病图标" />
        </div>
...
const pigImages = [
  ...
  new URL('@/assets/images/illnessImg/pig6.jpg', import.meta.url).href,
  new URL('@/assets/images/illnessImg/pig7.jpg', import.meta.url).href,
  new URL('@/assets/images/illnessImg/pig8.jpg', import.meta.url).href,
  new URL('@/assets/images/illnessImg/pig9.jpg', import.meta.url).href,
  new URL('@/assets/images/illnessImg/pig10.jpg', import.meta.url).href
];
