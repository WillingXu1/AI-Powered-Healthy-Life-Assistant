...
本项目是一个基于Spring AI的智能健康资讯与咨询系统，专注于AI驱动的个性化健康咨询。系统集成了AI健康风险评估、智能疾病查询、个性化用药建议和定制化健康计划四大核心功能。采用SpringBoot3 + Spring AI + Ollama + MySQL技术栈，通过RAG技术实现精准的症状分析和科学的健康建议生成，为用户提供专业、可靠的日常健康决策支持。
